L.Draw.FineArrow = L.Draw.SimpleShape.extend({
	...
	_drawShape: function (latlng) {
		if (!this._shape) {
			this._shape = new L.FineArrow(this._startLatLng, latlng, this.options.shapeOptions);
	...
	_fireCreatedEvent: function () {
		var fineArrow = new L.FineArrow(this._startLatLng, [this._shape.y, this._shape.x], this.options.shapeOptions);
